...
t_flow(1, "flujo 1: prueba", [O1, O3], F2),
t_flowAddOption(F2, O3, F3),
t_flowAddOption(F1, O1, F5),
t_flowAddOption(F5, O2, _),
%F2 = F3 = F6 true
t_chatbot(0, "Asist", "Bienvenido", 1, [F2], CB),
t_chatbot(0, "Asist", "Bienvenido", 1, [F2,F3], CB2),
t_chatbot(1, "Asist", "Bienvenido", 1, [F2,F3], CB3),
